          ...
          >
            ...
            <div>
              ...
              <p>
                ...
                une agilité d'esprit et une quête constante de créativité. Tout
                se déroulait normalement jusqu'en 4ème, où mon esprit agité et
              ...
              <p>
                ...
                expérience hors du commun, je mets en pratique ces leçons
                apprises dans chaque projet, apportant une touche unique et
                novatrice à chaque ligne de code que je crée.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                dans la manière dont je conçois le codage. Dès mon plus jeune
                âge, ma fascination pour les jeux vidéo a été le catalyseur qui
                m'a amené à explorer le monde complexe du développement
                informatique. Mon parcours a débuté par la rétro-ingénierie de
                jeux vidéo, où j'ai entrepris de modifier et d'adapter ces
                univers virtuels à mes propres préférences, fusionnant ainsi ma
                passion pour le jeu avec celle du codage.
              </p>
              <p>
              ...
              <p>
                ...
                ma mémoire ludique. Lorsque j'étais gosse, un ami généreux
                m'avait prêté le jeu "Advance Wars" sur Nintendo DS. C'était une
                immersion captivante dans le monde de la stratégie militaire, et
                je me suis tellement plongé dans l'univers du jeu que, je dois
                ...
                acte espiègle qui a peut-être forgé ma passion pour les mondes
                virtuels et les intrigues stratégiques. Après tout, certains
                jeux ont simplement un pouvoir irrésistible. Désolé, cher ami,
                si tu lis ceci. C'était une aventure mémorable! 😄
              </p>
            </div>
            <div>
              <h2>Ma formation</h2>
              <p>
                ...
                période qui a redéfini non seulement ma compréhension du code
                mais aussi ma manière d'interagir avec le monde qui m'entoure.
              </p>
              <p>
            ...
            <div>
              <h2>PlayCurious</h2>
              <p>
                Quand j'ai rejoint PlayCurious, j'ai été accueilli par une
                équipe dynamique et passionnée, qui m'a offert une immersion
                dans l'univers du développement de jeu vidéo. J'ai eu l'occasion
                de travailler sur une multitude de serious games, qui ont été
                une source inépuisable d'inspiration et d'apprentissage. J'ai
                également développé des compétences en gestion de projet, en
                travaillant avec des équipes de développeurs et de graphistes
                pour créer des jeux vidéo uniques.
              </p>
              <p>
